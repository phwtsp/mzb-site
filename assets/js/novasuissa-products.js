document.addEventListener("DOMContentLoaded", () => {
  ...
  const fallbackData = [
    ...
    },
    {
      ...
      description:
        "Filtro reutilizável Nova Suissa – sustentável, prático e econômico. Substitui os filtros descartáveis preservando o sabor natural do café, com fácil limpeza e durabilidade para o uso diário.",
    },
  ];
